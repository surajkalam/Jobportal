...
final appliedJobsProvider = StreamProvider.autoDispose<List<Map<String, dynamic>>>((ref) {
...
final filteredApplicationsProvider = Provider.autoDispose.family<List<Map<String, dynamic>>, String>((ref, status) {
  final applicationsAsync = ref.watch(appliedJobsProvider);
