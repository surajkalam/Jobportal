...
final jobseekerFirebaseServiceProvider = Provider<JobseekerFirebaseService>((ref) {
...
class JobseekerNotifier extends StateNotifier<JobseekerState> {
  ...
  Future<void> loadJobseekerInfo() async {
    try {
      ...
      final jobseekerInfo = await _firebaseService.getJobseekerInfo(_currentUserEmail);
  ...
  Future<void> saveJobseekerInfo(JobseekerModel jobseekerInfo) async {
    try {
      ...
      await _firebaseService.saveJobseekerInfo(jobseekerInfo, _currentUserEmail);
  ...
  Future<void> updateJobseekerInfo(JobseekerModel jobseekerInfo) async {
    try {
      ...
      await _firebaseService.updateJobseekerInfo(jobseekerInfo, _currentUserEmail);
...
// Jobseeker Provider
final jobseekerProvider = StateNotifierProvider<JobseekerNotifier, JobseekerState>((ref) {
